...
describe('Directive: buildium.angular-elements.popover', function () {
    var elem, $compile, scope, popoverCtrl, mockSubmenuSvc, mockPopUps, mockFilter;
    ...
    beforeEach(angular.mock.module('buildium.angular-elements.popover', function ($provide) {
        ...
        mockFilter = function mockFilter() {
    ...
    beforeEach(angular.mock.inject(function (_$rootScope_, _$compile_) {
        ...
        elem = angular.element('<bd-popover title="rentalsMenu.Title">' + '   <ul class="sub-menu">' + '       <li ng-repeat="menuItem in rentalsMenu.ChildItems" bd-menu-item="menuItem"></li>' + '   </ul>' + '</bd-popover>');
