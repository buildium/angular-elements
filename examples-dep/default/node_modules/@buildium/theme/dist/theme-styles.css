...
<div style="height: 80px; position: relative;">
    <div class="alert alert--infobar-urgent">
        ...
        <span class="alert__centered-text-with-icon">
            ...
            <div>This is an alert to notify users of a urgent problems, system outages or sitewide errors.&nbsp;<a class="alert__link" href="#">View status page</a>
        </span>
    </div>
</div>
...
<p>Wells can be used to highlight sections on a page. You can use "well--highlight-{direction}" (top, right, bottom, left) to change it's position.</p>
<p>Note: to highlight specific information to a user rather than a section, use an alert.</p>

Markup:
<div class="well">
    <p>This is a default well</p>
</div>
<div class="well well--highlight-left" style="margin-top:10px;">
    <p>This is a well with the highlight positioned at the left</p>
</div>
<div class="well well--highlight-top well--highlight-grey" style="margin-top:10px;">
    <p>This is a well with a grey highlight, positioned at the top</p>
</div>
<div class="well well--highlight-left well--muted" style="margin-top:10px;">
    <p>This is a muted well, with the highlight positioned at the left</p>
</div>
