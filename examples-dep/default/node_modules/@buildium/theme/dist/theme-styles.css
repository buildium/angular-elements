...
<div class="status-tag {{modifier_class}} status-tag--with-close">status text<div class="status-tag__close"></div></div>
...
.status-tag--error .status-tag__close {
  background-image: url("icons/delete-red.svg");
}
.status-tag--warning {
...
.status-tag--warning .status-tag__close {
...
.status-tag--severe-warning .status-tag__close {
...
.status-tag--success .status-tag__close {
...
.status-tag__close:hover,
.status-tag__close:focus {
  opacity: 1;
}
/*
Alerts
...
<div class="alert alert--addon alert--dismissable">
    <div class="alert__close alert__close--addon"></div>
...
<div style="height: 80px; position: relative;">
    <div class="alert alert--infobar">
        <div class="alert__close alert__close--infobar"></div>
...
.alert--severe-warning .alert__close {
  background-image: url("icons/delete-orange.svg");
}
.alert--error {
  color: #D4402B;
...
.alert--addon {
  padding: 15px 10px;
  color: #674172;
  background-color: rgba(165, 107, 217, 0.08);
  border-color: #674172;
  padding: 25px;
  font-size: 16px;
  height: 100px;
}
.alert--addon .alert__close {
...
.alert--infobar .alert__close,
.alert--infobar-urgent .alert__close {
  opacity: 1;
  background-image: url("icons/delete-white.svg");
}
.alert--infobar .alert__close:hover,
.alert--infobar-urgent .alert__close:hover {
  opacity: 0.5;
}
.alert--infobar-urgent {
...
.help-support-menu__loading {
  background: transparent url("icons/spinner-small.gif") 5px center no-repeat;
  padding-left: 30px;
}
.help-search {
  position: relative;
...
.datepicker__container--full-width {
  display: block;
  width: 100%;
}
...
.ui-datepicker-prev {
  float: left !important;
  background: url("icons/datepicker-prev-chevron.svg") no-repeat 15px 25px;
}
.ui-datepicker-prev:hover {
  background: url("icons/datepicker-prev-chevron-hover.svg") no-repeat 15px 25px;
}
.ui-datepicker-next {
  float: right !important;
  background: url("icons/datepicker-next-chevron.svg") no-repeat 10px 25px;
}
.ui-datepicker-next:hover {
  background: url("icons/datepicker-next-chevron-hover.svg") no-repeat 10px 25px;
}
.ie .ui-datepicker-buttonpane button {
  background: url("icons/bg-button.jpg") repeat-x;
}
...
.ui-datepicker-buttonpane {
  ...
  background: #C9C9C9 url("icons/datepicker-buttonpane-bg.png") 50% bottom repeat-x;
  border-radius: 0 0 5px 5px;
}
.ui-datepicker-close {
  float: right !important;
...
.ui-datepicker-trigger:before {
  ...
  top: -1px;
  right: 0;
  background: url("icons/datepicker-trigger.svg") center center no-repeat;
}
.ui-datepicker-title {
  background: white;
  border-bottom: 1px solid #E2E2E2;
...
.datepicker__container:hover .ui-datepicker-trigger:before {
  background: url("icons/datepicker-trigger-hover.svg") center center no-repeat;
}
...
.data-grid__row--highlight .data-grid__cell {
  background-color: #F2F2F2;
}
...
.less .dynamic-grid.data-grid--dynamic-grid input[type="text"] {
  height: 40px;
}
/*
...
.page-header__status-tag--aspx:first-child {
  margin-left: 10px;
}
...
#pageHead.page-header--header-refresh .button-container {
  padding-bottom: 0;
}
...
.alt.wizard #pageHead.page-header--static-header,
...
#pageHead.page-header--legacy-alert .page-header__middle-content {
  padding-top: 70px;
}
#pageHead.page-header--legacy-alert .hub-paging {
  margin-top: 70px;
}
#pageHead.page-header--legacy-alert #updateHeaderContainer {
  margin-top: 70px;
}
/*
Hub paging
...
<div class="kss-modifier__name kss-style">.btn--addon</div>
<div class="kss-modifier__description kss-style">Addon button</div>
<div class="kss-modifier__example">
    <button class="btn btn--addon">Sign up</button>
    <div class="kss-modifier__example-footer"></div>
</div>
...
<div role="radiogroup" aria-label="Toggle Direction">
    <button class="btn btn--toggle-left"
        role="radio"
        aria-checked="false">Left toggle</button>
    <button class="btn btn--toggle-right"
        role="radio"
        aria-checked="false">Right toggle</button>
</div>
<br/>
<br/>
...
<div role="radiogroup" aria-label="Toggle Direction">
    <button class="btn btn--toggle-left btn--toggle-left-selected"
        role="radio"
        aria-checked="true">Left toggle</button>
    <button class="btn btn--toggle-right"
        aria-checked="false">Right toggle</button>
</div>      
<br/>
...
<div role="radiogroup" aria-label="Toggle Direction">
    <button class="btn btn--toggle-left"
        role="radio"
        aria-checked="false">Left toggle</button>
    <button class="btn btn--toggle-right btn--toggle-right-selected"
        role="radio"
        aria-checked="true">Right toggle</button>
</div>
...
.btn--toggle-left:hover + .btn--toggle-right {
  border-left-color: #73B680;
}
.btn--toggle-left:active + .btn--toggle-right,
.btn--toggle-left:focus + .btn--toggle-right {
  border-left-color: #50975E;
}
.btn--toggle-right {
  color: #A5A5A6;
  border-radius: 0 4px 4px 0;
}
.btn--toggle-right:focus,
...
.btn--toggle-left-selected + .btn--toggle-right {
  border-left-color: #73B680;
}
.btn--toggle-left-selected:active + .btn--toggle-right:hover,
.btn--toggle-left-selected:focus + .btn--toggle-right:hover {
  border-left-color: #73B680;
}
.btn--toggle-left-selected:hover + .btn--toggle-right:active,
.btn--toggle-left-selected:hover + .btn--toggle-right:focus {
  border-left-color: #73B680;
}
...
.btn--wait {
  background: transparent url('icons/spinner-medium.gif') 5px center no-repeat;
  padding-left: 30px;
  font-size: 14px;
  font-style: italic;
  color: #666666;
...
.btn--waiting:before {
  ...
  height: 100%;
  z-index: 1000;
  background: url('icons/spinner-medium.gif') center left no-repeat;
}
.btn--circle {
  height: 40px;
  width: 40px;
...
.btn--send-sms {
  ...
  background-position: 12px center;
  background-size: 15px;
  background-image: url("icons/send-sms-white.svg");
  background-repeat: no-repeat;
}
.btn--send-sms:hover {
  color: #FFFFFF;
...
.btn--ql:before {
  ...
  height: 20px;
  display: block;
  background: url('icons//shortcuts-grey.png') no-repeat center;
  background-size: 20px;
}
.btn--ql:hover:before,
.btn--ql:focus:before,
.btn--ql:active:before {
  background: url('icons//shortcuts-green.png') no-repeat center;
  background-size: 20px;
}
.btn--neg-top-sm {
  margin-top: -10px;
...
.btn-loading--dark:before {
  ...
  margin-right: 10px;
  content: "";
  background: url("icons/spinner-dark.svg") no-repeat;
  vertical-align: middle;
...
.btn--send-sms[disabled]:before {
  ...
  height: 18px;
  content: "";
  background: url('icons/spinner-white.svg') no-repeat;
  vertical-align: middle;
  animation: rotation 1s infinite linear;
...
.button-group li:last-child .btn:focus {
...
.popup__loading-spinner {
  ...
  height: 30px;
  width: 100%;
  background: url("icons/spinner-medium.gif") center center no-repeat;
}
.simplemodal-data h2,
.simplemodal-data h2 {
...
<h3>Card with no shadow</h3>
<div class="card card--no-shadow">
    <p>This is a card with no box-shadow</p>
</div>
<h3>Cards with highlights</h3>
<div class="card card--highlight-left card--no-shadow">
...
<h3>Card that is muted</h3>
<div class="card card--highlight-left card--muted card--no-shadow">
...
.card__link-footer:hover,
.card__link-footer:active,
.card__link-footer:focus {
  border-top: 1px solid #E2E2E2;
}
.card--no-shadow {
  box-shadow: none;
...
.card--highlight-top {
  border-top: 5px solid #73B680;
}
.card--highlight-top.card--highlight-grey,
.card--highlight-top.card--muted {
  border-top-color: #BBBBBB;
}
.card--highlight-left {
  border-left: 5px solid #73B680;
}
.card--highlight-left.card--highlight-grey,
.card--highlight-left.card--muted {
  border-left-color: #BBBBBB;
}
.card--highlight-right {
  border-right: 5px solid #73B680;
}
.card--highlight-right.card--highlight-grey,
.card--highlight-right.card--muted {
  border-right-color: #BBBBBB;
}
.card--highlight-bottom {
  border-bottom: 5px solid #73B680;
}
.card--highlight-bottom.card--highlight-grey,
.card--highlight-bottom.card--muted {
...
.accordion-list__save-cancel-btn .svgicon--checkmark-white {
  width: 15px;
  height: 15px;
  margin-left: -1px;
}
.accordion-list__save-cancel-btn .svgicon--delete {
  margin-top: -3px;
...
.notification-center-menu-empty-state__message-icon {
  ...
  width: 73px;
  margin: 0 auto;
  background-image: url("icons//message-bubble-grey-disabled.svg");
  background-repeat: no-repeat;
  background-size: 100%;
}
...
.navigation--bordered .navigation__item {
...
<progress class="progress-bar progress-bar--contained" max="100" value="30"></progress>
...
.progress-bar::-webkit-progress-value {
  background: linear-gradient(270deg, #73B680, #50975E);
...
.progress-bar--contained::-webkit-progress-bar {
  background: #EAEAEA;
}
/*
Wells
...
.well--highlight-top.well--highlight-grey,
.well--highlight-top.well--muted {
  border-top-color: #BBBBBB;
}
.well--highlight-left {
  border-left: 5px solid #73B680;
}
.well--highlight-left.well--highlight-grey,
.well--highlight-left.well--muted {
  border-left-color: #BBBBBB;
}
.well--highlight-right {
  border-right: 5px solid #73B680;
}
.well--highlight-right.well--highlight-grey,
.well--highlight-right.well--muted {
  border-right-color: #BBBBBB;
}
.well--highlight-bottom {
  border-bottom: 5px solid #73B680;
}
.well--highlight-bottom.well--highlight-grey,
.well--highlight-bottom.well--muted {
  border-bottom-color: #BBBBBB;
}
/*
Timeline
        ...
        <div style="position:relative;">
            <div class="timeline__icon-container" style="position: relative; box-sizing: border-box;">
                <div class="timeline__icon-circle">
                    <div class="timeline__icon svgicon--comment"></div>
                </div>
            </div>
            <div class="timeline__card card card--with-arrow" style="width: 500px; height: 120px; display: inline-block;">
...
<div>
  <div class="property-images-modal__item-container">
      <ul class="property-images-modal__item-list">
          <li class="property-images-modal__item">
              <div class="property-images-modal__item-overlay">
                  <span>
                      <img class="property-images-modal__image" src="https://images.pexels.com/photos/323780/pexels-photo-323780.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=80&w=80" />
                  </span>
              </div>
          </li>
          <li class="property-images-modal__item">
          ...
          <li class="property-images-modal__item">
              <div class="property-images-modal__item-overlay">
                  <span>
                      <img class="property-images-modal__video" src="https://images.pexels.com/photos/323780/pexels-photo-323780.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=80&w=80" />
...
.property-images__container--no-click .property-images__property-placeholder:hover {
  background: url("/Manager/static-images/photo-sprite-property.png") 0 0 no-repeat;
}
...
.property-images__property-placeholder:hover {
  background: url("/Manager/static-images/photo-sprite-property.png") 0px -200px no-repeat;
}
...
.property-images-modal__item-overlay.icon-caption-overlay:after {
  height: 16px;
  width: 16px;
  position: absolute;
  right: 6px;
...
.property-images-modal__play-button {
  ...
  width: 36px;
  height: 36px;
  background: url("/Manager/static-images/gallery-sprite.png") no-repeat 0px -180px;
}
...
<div>
    <section>
        <h3>Radio button modal</h3>
        <div class="modal__overlay">
            <div class="modal__dialog-container modal__dialog" style="width: 646px; margin-top: 50px;">
                    <div class="modal__title">Confirm option</div>
                    <div class="radio-button-modal__text text-center">You must confirm the desired behavior on this action.</div>
                    <div class="radio-button-modal__text text-center">What do you want to do?</div>
                    <div class="form__vertical-spacer--medium"></div>
                    <div class="radio-button-modal__spacer-line"></div>
                    <div class="form__vertical-spacer--medium"></div>
                    <div class="form__vertical-spacer--large"></div>
                    <div class="row" style="height: 100px;">
                        <div class="radio-group">
                            <div>
                                <input type="radio" class="radio-group__btn" checked>
                                <label class="radio radio-button-modal__radio-group-label radio-button-modal__radio-button-option radio-button-modal__radio-button-option--selected">
                                    Do the thing then do the extra thing
                                    <div class="radio-button-modal__radio-button-option-description">This will do the thing and then do the extra thing for you.</div>
                                </label>
                            </div>
                            <div>
                                <input type="radio" class="radio-group__btn">
                                <label class="radio radio-button-modal__radio-group-label radio-button-modal__radio-button-option pull-right">
                                    Do the thing then do nothing else
                                    <div class="radio-button-modal__radio-button-option-description">This will do the thing only and skip doing any extra thing.</div>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="button-container right">
                        <button class="btn btn-link" style="padding-right: 15px;">Cancel</button>
                        <button class="btn btn--primary">Confirm and save charge</button>
                    </div>
                </div>
            </div>
    </section>
...
Styleguide 2.38
*/
.radio-button-modal__text {
  color: #4F4F52;
  font-size: 16px;
  line-height: 21px !important;
  font-weight: 500;
}
.radio-button-modal__radio-button-option {
  border: 1px solid #CFCFCF;
  width: 105px;
  height: 121px;
  float: left;
...
.radio-button-modal__radio-button-option:hover {
  border: 1px solid #73B680;
  box-shadow: 0 2px 10px 0 rgba(0, 0, 0, 0.05);
}
.radio-button-modal__spacer-line {
  display: block;
  margin-top: 26px;
  border-top: 1px solid #E2E2E2;
}
.radio-button-modal__radio-button-option-description {
  font-weight: 400;
  font-size: 12px;
  color: #4F4F52;
  line-height: 18px;
...
.radio-button-modal__radio-button-option--selected {
  border: 1px solid #73B680;
  background-color: #F1F8F2;
  border-radius: 5px;
  box-shadow: 0 2px 10px 0 rgba(0, 0, 0, 0.05);
}
.radio-group__btn + .radio-button-modal__radio-group-label:before {
  content: "";
  position: absolute;
  top: 20px;
  left: 20px;
...
.radio-group__btn:checked + .radio-button-modal__radio-group-label:before {
  background-color: #73B680;
  border-color: #50975E;
}
.radio-button-modal__radio-group-label {
  display: inline-block;
  position: relative;
  line-height: 26px;
  padding-left: 55px;
...
.radio-button-modal__selected-radio-button-styling {
  background-color: #73B680;
  border-color: #50975E;
}
.radio-button-modal__radio-button-styling {
  content: "";
  position: absolute;
  top: 20px;
  left: 20px;
...
Styles used to prepend or append information to an input

Markup:
<div style="display:block;width:30%;">
    <div class="form-element__input-group">
        <div class="form-element__input-group-prepend">Http://</div>
        <div class="form-element__input-group-input">
            <input type="text" class="form-element__input" placeholder="Placeholder text..."></input>
        </div>
    </div>
</div>
<div style="display:block;width:30%;margin-top:10px;">
    <div class="form-element__input-group">
        <div class="form-element__input-group-input">
            <input type="text" class="form-element__input" placeholder="Placeholder text..."></input>
        </div>
        <div class="form-element__input-group-append">.com</div>
    </div>
</div>
<div style="display:block;width:30%;margin-top:10px;">
    <div class="form-element__input-group">
        <div class="form-element__input-group-prepend form-element__input-group-prepend--action">
            <button class="btn btn--no-right-border-radius no-border">Action Button
                <span class="icon-link-menu-pointer"></span>
            </button>
        </div>
        <div class="form-element__input-group-input">
...
Styleguide 3.2.1
*/
.form-element__input-group {
  display: flex;
}
.form-element__input-group-input {
  flex: 1 0 auto;
}
.form-element__input-group-input .form-element__input {
  border-radius: 0 5px 5px 0;
}
.form-element__input-group-input:first-child .form-element__input {
  border-radius: 5px 0 0 5px;
}
.form-element__input-group-prepend,
.form-element__input-group-append {
  padding: 10px;
  background: #F4F4F4;
  border: 1px solid #E2E2E2;
  color: #767676;
...
.form-element__input-group-prepend--action,
.form-element__input-group-append--action {
  padding: 0;
}
/*
...
<div class="input-confirm-cancel--edited">
    read only input
    <span class="icon-pencil input-confirm-cancel__icon" aria-label="Edit Label"></span>
</div>
...
.selectize-dropdown [data-selectable].js-selected--dropdown-open {
  font-weight: 700;
  letter-spacing: 0.5px;
}
.selectize-dropdown [data-selectable],
...
.payment-cards--mastercard {
  background: url("icons/mastercard.svg") no-repeat;
  opacity: .3;
}
...
.payment-cards--discover {
  background: url("icons/discover.png") no-repeat;
  opacity: .3;
...
.add-tags__tag:hover .add-tags__remove-button {
  background: url("icons/add-tags-remove-red.svg") no-repeat !important;
}
.add-tags__remove-button {
  display: inline-block;
  background: url("icons/add-tags-remove-grey.svg") no-repeat !important;
  width: 14px;
  height: 14px;
  cursor: pointer;
  position: absolute;
...
.add-tags__dropdown-toggle:after {
  ...
  height: 100%;
  border: none;
  background: url("icons/add-tags-trigger-grey.svg") no-repeat;
}
...
.add-tags-btn .icon-add-tags {
  background: url("icons/add-tags-trigger-grey.svg") no-repeat !important;
...
.incrementor__btn:hover,
.incrementor__btn:focus,
.incrementor__btn:active {
  box-shadow: none;
  border-color: #73B680;
}
.incrementor__btn[disabled] {
  background-color: #F4F4F4;
...
.incrementor__btn--increment:hover {
  background-image: url("icons/theme-add-hover.png");
}
.incrementor__btn--increment:hover {
  background-image: url("icons/add-green.svg") !important;
}
.incrementor__btn--increment:focus,
.incrementor__btn--increment:active {
  cursor: pointer;
  background-image: url("icons/add-green.svg");
  background-repeat: no-repeat;
  background-position: left center;
...
.incrementor__btn--increment[disabled] {
...
.incrementor__btn--decrement:hover,
.incrementor__btn--decrement:focus,
.incrementor__btn--decrement:active {
  cursor: pointer;
  background-image: url("icons/subtract-green.svg");
  background-repeat: no-repeat;
  background-position: left center;
...
.incrementor__btn--decrement[disabled] {
...
.incrementor__input::-webkit-inner-spin-button,
.incrementor__input::-webkit-outer-spin-button {
  -webkit-appearance: none;
  margin: 0;
}
.incrementor__input:hover,
.incrementor__input:focus {
  border: 1px solid #73B680;
}
/*
    Validation popups
